...
/*SF_DATA;ver:1.38;sub:START;pass:START;ps:flbk:,iptp:0,cusa:False,bamd:0,cgin:,lico:1,lgpr:1,limd:1,spmd:1,trmd:0,grmd:0,uamb:True,mssp:True,bkdf:False,hqlp:False,rprd:False,enco:False,rmgx:True,imps:True,rpth:0,vtps:0,hqsc:True,nrmq:1,nrsp:0,vomd:0,spxs:False,tesm:0,olmd:1,culm:0,bsrc:0,bdst:1,dpts:2,wrdp:True,dith:0,atcv:False,rfrpo:True,rfrpn:Refraction,coma:15,ufog:True,aust:True,igpj:False,qofs:0,qpre:1,rntp:1,fgom:False,fgoc:False,fgod:False,fgor:False,fgmd:0,fgcr:0.5,fgcg:0.5,fgcb:0.5,fgca:1,fgde:0.01,fgrn:0,fgrf:300,stcl:False,atwp:False,stva:128,stmr:255,stmw:255,stcp:6,stps:0,stfa:0,stfz:0,ofsf:0,ofsu:0,f2p0:False,fnsp:False,fnfb:False,fsmp:False;n:type:ShaderForge.SFN_Final,id:4013,x:33987,y:32589,varname:node_4013,prsc:2|diff-1550-OUT;n:type:ShaderForge.SFN_Color,id:1304,x:32972,y:32461,ptovrint:False,ptlb:Color,ptin:_Color,varname:node_1304,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:1,c2:0.8068964,c3:0,c4:1;n:type:ShaderForge.SFN_Multiply,id:8338,x:33270,y:32457,varname:node_8338,prsc:2|A-1304-RGB,B-8913-OUT;n:type:ShaderForge.SFN_Tex2d,id:7065,x:32072,y:32796,varname:node_7065,prsc:2,tex:29b5ade739ebc4043acc31936fef01a5,ntxv:0,isnm:False|UVIN-4278-OUT,TEX-497-TEX;n:type:ShaderForge.SFN_Color,id:5547,x:33285,y:32299,ptovrint:False,ptlb:bg,ptin:_bg,varname:node_5547,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:1,c2:0.3455882,c3:0.3455882,c4:1;n:type:ShaderForge.SFN_Clamp01,id:1628,x:33459,y:32457,varname:node_1628,prsc:2|IN-8338-OUT;n:type:ShaderForge.SFN_Lerp,id:1550,x:33689,y:32446,varname:node_1550,prsc:2|A-5547-RGB,B-1628-OUT,T-2893-OUT;n:type:ShaderForge.SFN_Slider,id:2893,x:33363,y:32597,ptovrint:False,ptlb:lerp,ptin:_lerp,varname:node_2893,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0,cur:0.4287949,max:1;n:type:ShaderForge.SFN_Tex2dAsset,id:497,x:31599,y:32571,ptovrint:False,ptlb:bamboo,ptin:_bamboo,varname:node_497,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,tex:29b5ade739ebc4043acc31936fef01a5,ntxv:0,isnm:False;n:type:ShaderForge.SFN_Tex2d,id:7045,x:32061,y:32952,varname:node_7045,prsc:2,tex:29b5ade739ebc4043acc31936fef01a5,ntxv:0,isnm:False|UVIN-6162-OUT,TEX-497-TEX;n:type:ShaderForge.SFN_TexCoord,id:547,x:31197,y:33009,varname:node_547,prsc:2,uv:0,uaff:False;n:type:ShaderForge.SFN_Add,id:2468,x:32703,y:32939,varname:node_2468,prsc:2|A-1913-OUT,B-8542-OUT,C-3865-OUT;n:type:ShaderForge.SFN_Clamp01,id:8913,x:32939,y:32939,varname:node_8913,prsc:2|IN-2468-OUT;n:type:ShaderForge.SFN_Multiply,id:6162,x:31764,y:33014,varname:node_6162,prsc:2|A-1316-UVOUT,B-454-OUT;n:type:ShaderForge.SFN_Slider,id:454,x:31282,y:33187,ptovrint:False,ptlb:scale1,ptin:_scale1,varname:node_454,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0.1,cur:1.903082,max:5;n:type:ShaderForge.SFN_Rotator,id:1316,x:31451,y:33009,varname:node_1316,prsc:2|UVIN-547-UVOUT,ANG-6053-OUT;n:type:ShaderForge.SFN_Vector1,id:6053,x:31150,y:33173,varname:node_6053,prsc:2,v1:23;n:type:ShaderForge.SFN_Tex2d,id:2470,x:32061,y:33175,varname:node_2470,prsc:2,tex:29b5ade739ebc4043acc31936fef01a5,ntxv:0,isnm:False|UVIN-8756-OUT,TEX-497-TEX;n:type:ShaderForge.SFN_Multiply,id:8756,x:31774,y:33200,varname:node_8756,prsc:2|A-7899-UVOUT,B-4197-OUT;n:type:ShaderForge.SFN_Rotator,id:7899,x:31473,y:33262,varname:node_7899,prsc:2|UVIN-547-UVOUT,ANG-3799-OUT;n:type:ShaderForge.SFN_Vector1,id:3799,x:31150,y:33330,varname:node_3799,prsc:2,v1:40;n:type:ShaderForge.SFN_Slider,id:4197,x:31316,y:33455,ptovrint:False,ptlb:scale2,ptin:_scale2,varname:node_4197,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0.1,cur:1,max:5;n:type:ShaderForge.SFN_TexCoord,id:1142,x:31137,y:32725,varname:node_1142,prsc:2,uv:0,uaff:False;n:type:ShaderForge.SFN_Multiply,id:4278,x:31599,y:32774,varname:node_4278,prsc:2|A-1142-UVOUT,B-7-OUT;n:type:ShaderForge.SFN_Slider,id:7,x:31105,y:32928,ptovrint:False,ptlb:scale0,ptin:_scale0,varname:node_7,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,min:0.1,cur:1,max:5;n:type:ShaderForge.SFN_Multiply,id:1913,x:32468,y:32756,varname:node_1913,prsc:2|A-1166-RGB,B-7065-RGB;n:type:ShaderForge.SFN_Color,id:1166,x:32224,y:32652,ptovrint:False,ptlb:leaves1,ptin:_leaves1,varname:node_1166,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0.4931034,c2:0.5,c3:0,c4:1;n:type:ShaderForge.SFN_Multiply,id:8542,x:32495,y:32906,varname:node_8542,prsc:2|A-6065-RGB,B-7045-RGB;n:type:ShaderForge.SFN_Multiply,id:3865,x:32453,y:33101,varname:node_3865,prsc:2|A-9715-RGB,B-2470-RGB;n:type:ShaderForge.SFN_Color,id:6065,x:32224,y:32838,ptovrint:False,ptlb:leaves2,ptin:_leaves2,varname:_leaves2,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:1,c2:0.6827586,c3:0,c4:1;n:type:ShaderForge.SFN_Color,id:9715,x:32224,y:33024,ptovrint:False,ptlb:leaves3,ptin:_leaves3,varname:_leaves3,prsc:2,glob:False,taghide:False,taghdr:False,tagprd:False,tagnsco:False,tagnrm:False,c1:0.6470588,c2:0.3882353,c3:0,c4:1;proporder:1304-5547-2893-497-454-4197-7-1166-6065-9715;pass:END;sub:END;*/
...
Shader "Shader Forge/bambooLeavesFloor" {
    Properties {
        ...
        _leaves1 ("leaves1", Color) = (0.4931034,0.5,0,1)
        _leaves2 ("leaves2", Color) = (1,0.6827586,0,1)
        _leaves3 ("leaves3", Color) = (0.6470588,0.3882353,0,1)
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
        ...
        Pass {
            ...
            uniform float4 _leaves1;
            uniform float4 _leaves2;
            uniform float4 _leaves3;
            struct VertexInput {
...
/////// Diffuse:
                ...
                float3 diffuseColor = lerp(_bg.rgb,saturate((_Color.rgb*saturate(((_leaves1.rgb*node_7065.rgb)+(_leaves2.rgb*node_7045.rgb)+(_leaves3.rgb*node_2470.rgb))))),_lerp);
