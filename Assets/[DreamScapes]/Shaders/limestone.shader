...
/////// Diffuse:
                ...
                float3 diffuseColor = (_Color.rgb*floor(dot(lightDirection,i.normalDir) * _posturisenum) / (_posturisenum - 1)*_node_5460_var.rgb);
