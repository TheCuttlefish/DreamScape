...
Shader "Shader Forge/boundery" {
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform sampler2D _node_7348; uniform float4 _node_7348_ST;
            struct VertexInput {
...
////// Emissive:
                ...
                float4 _node_7348_var = tex2D(_node_7348,TRANSFORM_TEX(i.uv0, _node_7348));
                float2 node_3820 = ((_node_7348_var.r*i.uv0)+node_4217*float2(0,1));
