...
Shader "Shader Forge/tree_leaves" {
    Properties {
        ...
        _node_6749 ("node_6749", Range(0, 1)) = 0.03679975
        _node_8564 ("node_8564", Range(0, 3)) = 3
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform float _node_6749;
            uniform float _node_8564;
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float4 _node_748_var = tex2Dlod(_node_748,float4(TRANSFORM_TEX(o.uv0, _node_748),0.0,0));
                float node_7885 = (_node_748_var.r*1.0+0.0);
                float4 node_7136 = _Time;
                v.vertex.xyz += ((node_7885*_node_8564)*v.normal*(sin(node_7136.g)*_node_6749)*mul(unity_ObjectToWorld, v.vertex).rgb);
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float4 _node_748_var = tex2D(_node_748,TRANSFORM_TEX(i.uv0, _node_748));
                float node_7885 = (_node_748_var.r*1.0+0.0);
                clip(node_7885 - 0.5);
...
/////// Diffuse:
                ...
                float3 node_4135 = (_LightColor0.rgb*lerp(_node_7243.rgb,_node_2381.rgb,floor(_node_748_var.r * _noise) / (_noise - 1)));
