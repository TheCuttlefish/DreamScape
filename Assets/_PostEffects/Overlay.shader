...
Shader "Shader Forge/Overlay" {
    Properties {
        ...
        [MaterialToggle] _hueSlide ("hueSlide", Float ) = 0
    }
    SubShader {
        Tags {
...
////// Lighting:
////// Emissive:
                float4 node_9007 = _Time;
                float node_6628_ang = node_9007.g;
                ...
                float3 node_8397 = lerp(lerp( _uv_distortion_var.rgb, (lerp(float3(1,1,1),saturate(3.0*abs(1.0-2.0*frac(node_7852.r+float3(0.0,-1.0/3.0,1.0/3.0)))-1),sin(node_631.g))*node_7852.b), _hueSlide ),float3(i.uv0,0.0),(_amount*-0.999+1.0)); // Refract here
